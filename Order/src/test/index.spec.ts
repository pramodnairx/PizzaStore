...
import { app } from '../service/adapters/order-service-http';
...
const reset = function() {
    ...
    orders = [(new class implements Order {orderID = "000002"; customerName = "Hungrier Jack"; customerAddress = "213 Hungryville 3026"; status = OrderStatus.Initialized; items = [items[0], items[1]] }())];
}
