...
exports.StoreFrontMongoDBModel = void 0;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.connected) {
                try {
                    ...
                    yield mongoose_1.default.connect(config_1.default.get(`storeFrontService.db.connectionString`));
...
exports.StoreFrontMongoDBModel = StoreFrontMongoDBModel;
